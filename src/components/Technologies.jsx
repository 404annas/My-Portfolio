...
import { SiRedux, SiFirebase, SiGreensock } from "react-icons/si";
  ...
  return (
    <div className="border-b border-x-neutral-800 pb-24">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        >
          <RiHtml5Line className="text-6xl text-red-600" />
        </motion.div>
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <RiCss3Line className="text-6xl text-blue-600" />
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiGreensock className="text-6xl text-green-500" />
        </motion.div>
      </div>
    </div>
  );
